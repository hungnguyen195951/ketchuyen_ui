					...
					"config": {
						"groups": [{
							"tiles": [{
								...
								"properties": {
									"title": "Chức năng upload Batch và áp giá",
									"targetURL": "#zupbatch-display"
								}
							}]
						}]
					}
			...
			"ClientSideTargetResolution": {
				"adapter": {
					"config": {
						"inbounds": {
							"zupbatch-display": {
								"semanticObject": "zupbatch",
								"action": "display",
								"description": "Chức năng upload Batch và áp giá",
								"title": "Chức năng upload Batch và áp giá",
								"signature": {
									"parameters": {}
								},
								"resolutionResult": {
									...
									"additionalInformation": "SAPUI5.Component=zupbatch",
									"url": sap.ui.require.toUrl("zupbatch")
								}
							}
						}
					}
