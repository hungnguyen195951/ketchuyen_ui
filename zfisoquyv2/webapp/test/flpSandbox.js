			...
			"ClientSideTargetResolution": {
				"adapter": {
					"config": {
						"inbounds": {
							"zfisoquyv2-display": {
								"semanticObject": "zfisoquyv2",
								"action": "display",
								"description": "Sổ quỹ application.",
								"title": "Sổ quỹ tiền mặt",
								"signature": {
									"parameters": {}
								},
								"resolutionResult": {
									...
									"additionalInformation": "SAPUI5.Component=zfisoquyv2",
									"url": sap.ui.require.toUrl("zfisoquyv2")
								}
							}
						}
					}
