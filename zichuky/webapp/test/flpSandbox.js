			...
			"ClientSideTargetResolution": {
				"adapter": {
					"config": {
						"inbounds": {
							"zichuky-display": {
								"semanticObject": "zichuky",
								"action": "display",
								"description": "Chữ ký application.",
								"title": "Chữ ký",
								"signature": {
									"parameters": {}
								},
								"resolutionResult": {
									...
									"additionalInformation": "SAPUI5.Component=zichuky",
									"url": sap.ui.require.toUrl("zichuky")
								}
							}
						}
					}
