                    ...
                    oModel.read(`/ZFI_I_KC_FINAL(${urlParams})/Results`, {
                        success: function (oData, oResponse) {
                            ...
                            let reviewData = {
                                ...
                                documenType : 'KC',
                                postingDate :  `${date.getFullYear()}${date.getMonth() + 1}${date.getDate()}`,
                                postingDate_Ui : `<strong>Posting date: </strong>${date.getDate()}/${date.getMonth() + 1}/${date.getFullYear()}`,
                                documentDate : `${date.getFullYear()}${date.getMonth() + 1}${date.getDate()}`,
                                documentDate_Ui : `<strong>Document date: </strong>${date.getDate()}/${date.getMonth() + 1}/${date.getFullYear()}`,
                                items : []
                            }
                    ...
                    oModel.read(`/zfi_i_dockc_current(P_CompanyCode='${filterObject['$Parameter.P_CompanyCode']}',P_FiscalYear='${filterObject['$Parameter.P_FiscalYear']}',P_FiscalPeriod='0${filterObject['$Parameter.P_FiscalPeriod']}',P_RuleType='${filterObject['$Parameter.P_RuleType']}')/Set`, {
                        success: function (oData, oResponse) {
                            let docKC = {
                                ...
                                postingDate :`${oData.results[0].PostingDate.getFullYear()}${oData.results[0].PostingDate.getMonth() + 1}${oData.results[0].PostingDate.getDate()}`
