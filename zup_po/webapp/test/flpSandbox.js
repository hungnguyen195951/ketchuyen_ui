					...
					"config": {
						"groups": [{
							"tiles": [{
								...
								"properties": {
									"title": "Upload Purchasing Document ",
									"targetURL": "#zuppo-display"
								}
							}]
						}]
					}
			...
			"ClientSideTargetResolution": {
				"adapter": {
					"config": {
						"inbounds": {
							"zuppo-display": {
								"semanticObject": "zuppo",
								"action": "display",
								"description": "Upload Purchasing Document ",
								"title": "Upload Purchasing Document ",
								"signature": {
									"parameters": {}
								},
								"resolutionResult": {
									...
									"additionalInformation": "SAPUI5.Component=zuppo",
									"url": sap.ui.require.toUrl("zuppo")
								}
							}
						}
					}
