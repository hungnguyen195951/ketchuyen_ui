					...
					"config": {
						"groups": [{
							"tiles": [{
								...
								"properties": {
									"title": "Upload xuất kho hàng tặng",
									"targetURL": "#zuphangtang-display"
								}
							}]
						}]
					}
			...
			"ClientSideTargetResolution": {
				"adapter": {
					"config": {
						"inbounds": {
							"zuphangtang-display": {
								"semanticObject": "zuphangtang",
								"action": "display",
								"description": "Upload xuất kho hàng tặng",
								"title": "Upload xuất kho hàng tặng",
								"signature": {
									"parameters": {}
								},
								"resolutionResult": {
									...
									"additionalInformation": "SAPUI5.Component=zuphangtang",
									"url": sap.ui.require.toUrl("zuphangtang")
								}
							}
						}
					}
