					...
					"config": {
						"groups": [{
							"tiles": [{
								...
								"properties": {
									"title": "Upload Transfer Posting",
									"targetURL": "#zuptransfer-display"
								}
							}]
						}]
					}
			...
			"ClientSideTargetResolution": {
				"adapter": {
					"config": {
						"inbounds": {
							"zuptransfer-display": {
								"semanticObject": "zuptransfer",
								"action": "display",
								"description": "Upload Transfer Posting",
								"title": "Upload Transfer Posting",
								"signature": {
									"parameters": {}
								},
								"resolutionResult": {
									...
									"additionalInformation": "SAPUI5.Component=zuptransfer",
									"url": sap.ui.require.toUrl("zuptransfer")
								}
							}
						}
					}
